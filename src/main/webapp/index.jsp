...
<body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<div class="menu-wrap">
		...
		<i class="icon-remove menu-close"></i> <a href="#home"
			...
			class="smoothScroll">Services</a> <a href="#about"
			class="smoothScroll">About</a> <a href="#"><i
	...
	<div id="g">
		<div class="container">
			<div class="row">
				...
				<br> <br>
				<div class="col-lg-3">
					<a href="${pageContext.request.contextPath}/blogList.do"><img src="assets/img/s1.png"></a>
					<h4>博客列表</h4>
