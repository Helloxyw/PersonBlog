...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			<h1 class="logo"><a href="index.jsp#home">RicardoXu</a></h1>
	...
	<div id="w">
		<div class="container">
			<div class="row">
				...
				<h3>WELCOME TO <bold>MY BLOG</bold>. <bold>BASED ON BOOTSTRAP 3</bold> THEME. CRAFTED WITH LOVE BY <bold>BLACKTIE.CO</bold>. <br/>
			...
			<div class="row">
				...
				<div class="col-lg-4 desc desc-b">
					...
					<p>
						...
						<i class="icon-globe"></i> blog,pockerface.cn<br/>
					</p>
				</div>
			</div>
		</div><!-- /container -->
		...
		<div class="container">
			...
			<br>
				<div class="col-lg-4 col-lg-offset-4">
					<a href="index.jsp#portfolio" style="font-size:20px;">< <i class="icon-th-large"></i> > </a>
				</div>
			</div>
		</div>
	</div><!-- /dg -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 ">
					...
					<img class="img-circle" src="assets/img/1.jpg" height="90" width="90">

					<h4>Ricardo Xu</h4>
					<h5><i>菜鸟后端</i></h5>
					<p>Just Do it!</p>
					<p>
						<a href="index.jsp#"><i class="icon-facebook"></i></a>
						<a href="index.jsp#"><i class="icon-twitter"></i></a>
						<a href="index.jsp#"><i class="icon-envelope"></i></a>
